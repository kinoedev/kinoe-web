  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative flex min-h-screen">
        {/* Pass status into Sidebar so it can render Agent online/offline */}
        <Sidebar agentOnline={agentOnline} lastCheckedAt={lastCheckedAt} />

        <main className="flex-1">
          {/* Optional: pass into Topbar too if you want it up there */}
          <Topbar agentOnline={agentOnline} />
          ...
          <div className="grid gap-6 p-6 lg:grid-cols-3">
            ...
            <div className="lg:col-span-1">
              <SignalPanel agentOnline={agentOnline} />
            </div>
          </div>
        </main>
      </div>
